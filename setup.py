...
setup(
    ...
    project_urls={
        "Tracker": "https://github.com/BlackCatDevel0per/python-opencv_ffmpeg_streaming/issues",
        "Community": "https://github.com/BlackCatDevel0per/python-opencv_ffmpeg_streaming",
